            ...
            egui::ScrollArea::vertical().show(ui, |ui| {
                egui::ScrollArea::horizontal().show(ui, |ui| {
                    ...
                    if self.victory{
                        ...
                        let min_row_height = (available_size.y*0.99 - 140.0)  / num_rows as f32;
                        ...
                        if self.start {
                            ...
                            ui.vertical_centered_justified(|ui| {
                                ...
                                if(self.image_size != 200) {
                                    center_image = center_image - 256.0;
                                }
                                else {
...
fn load_image(mut game_state: &mut GameState) -> () {
    if game_state.image_size == 200{
        ...
        game_state.logo_picture = "resources/logo(2).png";
        for i in 0 .. game_state.number_of_cards {
        ...
        game_state.exit_picture = "resources/logo.png";
        game_state.logo_picture = "resources/logo(1).png";
